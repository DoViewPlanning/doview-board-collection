...
```
## Rights and reuse
No repository-wide open-content licence is applied to the board models in this collection because these DoView Boards are generated from public web information using the DoView Board Prompt Package:
https://doviewplanning.org/prompt
They are provided for viewing, discussion, and demonstration.
If you believe a board contains material that should be removed, corrected, attributed, or handled differently, please contact us:
https://doviewplanning.org/contact
## DoView software and trademarks
The DoView Boards prompt package and reference engine are maintained separately in the `doview-boards` repository under Apache-2.0.
...
https://doviewplanning.org/trademarkuse
## Important notes
Standalone DoView Board HTML files are active HTML/JavaScript files.
Read-only mode is not a security boundary.
